...
intrinsic_growth_rate_cpp11 <- function(mx, Lx, age_mid, max_iter, tol, deriv_tol) {
  .Call(`_poputils_intrinsic_growth_rate_cpp11`, mx, Lx, age_mid, max_iter, tol, deriv_tol)
}
