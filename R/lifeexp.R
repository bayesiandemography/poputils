...
#' \describe{
#'   \item{`"lt"`}{Life table age groups
#'         `"0", "1-4", "5-9", \dots, "A+"`}
#'   \item{`"single"`}{`"0", "1", "2", \dots, "A+"`}
#'   \item{`"five"`}{`"0-4", "5-9", \dots, "A+"`}
#' }
#' The last interval is always assumed to be open, meaning that
#' it includes everyone over a certain age.
#'
#' There are six choices for the `method` argument.
