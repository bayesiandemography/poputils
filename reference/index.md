...
- [`check_equal_length()`](https://bayesiandemography.github.io/poputils/reference/check_equal_length.md)
...
- [`groups_colnums()`](https://bayesiandemography.github.io/poputils/reference/groups_colnums.md)
  : Get a named vector of column indices for the grouping variables in a
  grouped data frame
...
- [`tfr_to_asfr_scale()`](https://bayesiandemography.github.io/poputils/reference/tfr_to_asfr_scale.md)
  : Derive Age-Specific Fertility Rates that Match Total Fertility Rates
  by Scaling
